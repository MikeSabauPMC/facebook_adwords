- dashboard: facebook__adwords_comparison
  ...
  - name: Spend and CPC
    ...
    sorts:
    - ads_compare.cost_per_click desc
    limit: 500
    column_limit: 50
    stacking: ''
    show_value_labels: false
    ...
    - label:
      ...
      valueFormat:
      series:
      - id: ads_compare.spend
        name: Ads Compare Spend
    - label: ''
      maxValue:
      minValue:
      orientation: right
      ...
      valueFormat:
      series:
      - id: ads_compare.cost_per_click
        name: Ads Compare Cost per Click
    row: 9
    col: 0
    width: 12
    height: 7
